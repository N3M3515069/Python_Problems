...
def nb_months(
    ...
    if start_price_old >= start_price_new:
        return [month_counter, start_price_old - start_price_new]
    ...
    while savings + start_price_old < start_price_new:
        ...
        start_price_new = start_price_new - (
            (percent_loss_by_month / 100) * start_price_new
        )
        start_price_old = start_price_old - (
            (percent_loss_by_month / 100) * start_price_old
        )

    return [month_counter, round(savings + start_price_old - start_price_new)]
